...
public class AnwersAdapter extends RecyclerView.Adapter<AnwersAdapter.ViewHolder> {
    private List<QuestionModel> quesList;

    public AnwersAdapter(List<QuestionModel> quesList) {
        this.quesList = quesList;
    }

    @NonNull
    @Override
    public AnwersAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =LayoutInflater.from(parent.getContext()).inflate(R.layout.answer_item_layout,parent,false);
        return new AnwersAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AnwersAdapter.ViewHolder holder, int position) {
